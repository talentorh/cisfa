...
<div class="table-responsive">
    ...
    <table class="table table-bordered table-striped" style="width: 99%; float: left; margin-left: 10px; margin-top: 0px; font-size: 12px;">
        ...
        <tbody>
            ...
            $sql = $conexion2->query("SELECT *, left(descripcionDelBien, 500) as descripcion from ordensuministro where claveUnicaOrden = '$claveEntrega' and farmacia = 'gratuita'  order by claveHraei asc");
