...
class PDF extends FPDF {
   ...
   function Footer()
   {
    ...
    //Número de página
    $this->Image('imagenes/logopie2023.png' , -40 ,550, 925 , 35);
...
Centro Integral del Servicios Farmacéuticos.'), 0);
    ...
    $pdf->SetFont('Arial', '', 9);
    $pdf->Cell(570, 25, '', 0);
    $fechapenalizacion = date("d-m-Y", strtotime($rowfechapenalizacion['fechaRegistroPenalizacion']));
    $pdf->Cell(300, 20, utf8_decode('Ixtapaluca, Estado de México a ').$fechapenalizacion.'', 0);
    $pdf->Ln(10);
    $pdf->Cell(570, 25, '', 0);
