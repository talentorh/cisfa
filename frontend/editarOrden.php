...
<select name="agregarbirmex" id="agregarbirmex" class="form-control" required style="height: 32px;">
  ...
  echo '<a href="editarMontoOrden?claveContrato=' . $claveUnicaEncriptada . '&total=' . $montoEncriptado . '&birmex=' . $claveUnica3 . '" class="btn btn-success" style="width: 170px; float: right; margin-right: 50px; margin-top: 0px;" id="seagregabirmex">Aplicar cambios</a>';
  echo '<a href="editarMontoOrden?claveContrato=' . $claveUnicaEncriptada . '&total=' . $montoEncriptado . '&birmex=" class="btn btn-warning" style="width: 170px; float: right; margin-right: 50px; margin-top: 0px;" id="sinbirmex">Aplicar cambios</a>';
  ?>
