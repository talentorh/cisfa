...
<body>
    ...
    <header>
        ...
        <strong class="strong">ORDENES FG</strong>
        ...
        <div class="box3">
            ...
            <datalist id="medicamentoEnOrdenFG">
                <?php
                require 'conexion.php';
                $sql_s = $conexion2->query("SELECT DISTINCT claveHraei, descripcionDelBien FROM ordensuministro where fechacontrato = $fechacontrato and farmacia = 'gratuita'");
            ...
            <div id="tabla_resultados" class="table table-responsive table-striped table-darkgray table-hover" style="cursor: pointer;  margin-left: 0px; margin-top: 0px; font-size: 12px; overflow-x: hidden; overflow-y: scroll; height: auto; line-height: 1em; width: 100%;"></div>
                ...
                <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="vistaPenalizaciones?var=' . $var3 . '&valor2=' . $claveUnica . '"><i id="pdf" class="lnr lnr-file-empty"  style="width: 80px; height: 20px; font-size: 22px; text-align: center;"></a></i></td>
