...
error_reporting(0);
 function formatMoney($number, $cents = 1) { // cents: 0=never, 1=if needed, 2=always
    ...
    FROM proveedores inner join datosproveedor on datosproveedor.id_datoProveedor = proveedores.numero_proveedor where datosproveedor.datoPersonalProveedor = '$proveedor' and proveedores.tipoFarmacia = 'intrahospitalaria 2023'";
    ...
    if(!empty($buscarAlumnos) AND mysqli_num_rows($buscarAlumnos)>0)
    {
        ...
        <table id="tabla"  class="table table-striped table-darkgray table-hover"  cellspacing="0" width="100%"  >
