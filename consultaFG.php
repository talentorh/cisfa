...
$sql = "SELECT COUNT(*) total FROM proveedores WHERE year = $contrato and tipoFarmacia = '$tipo'";
$result = mysqli_query($conexion2, $sql);
$fila = mysqli_fetch_assoc($result);


$query = $conexion2->query("SELECT datosproveedor.id_datoProveedor, datosproveedor.datoPersonalProveedor,
