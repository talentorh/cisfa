    ...
    <li class="nav-item">
      ...
      <li class="nav-item dropdown" >
        ...
        <div class="dropdown-menu" style="margin: 0px; font-size: 14px; padding: 0px; background: #F8F8F8;">
          <input type="hidden" value="2023" id="contrato2023"><input type="hidden" value="intrahospitalaria 2023" id="tipo2023">
          <a class="dropdown-item" href="#" style="font-size: 13px;" onclick="select_contrato2023();">2023</a>
          <input type="hidden" value="2024" id="contrato2024"><input type="hidden" value="intrahospitalaria 2024" id="tipo2024">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" style="margin: 0px; font-size: 14px; padding: 0px; background: #F8F8F8;">
            <a class="dropdown-item" href="#" target="_blank" style="font-size: 13px;" data-toggle="modal" data-target="#myModal_salidasCisfa">2023</a>
            <a class="dropdown-item" href="#" target="_blank" style="font-size: 13px;" data-toggle="modal" data-target="#myModal_salidasCisfa2024">2024</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-expanded="false">
        ...
        <div class="dropdown-menu" style="margin: 0px; font-size: 14px; padding: 0px; background: #F8F8F8;">
            <a class="dropdown-item" href="reporteEntregasOs" target="_blank" style="font-size: 13px;">Faltante de entregas 2023</a>
            <a class="dropdown-item" href="reporteEntregado" target="_blank" style="font-size: 13px;">Entregado 2023</a>
            <a class="dropdown-item" href="reporteEntregasOs2024" target="_blank" style="font-size: 13px;">Faltante de entregas 2024</a>
            <a class="dropdown-item" href="reporteEntregado2024" target="_blank" style="font-size: 13px;">Entregado 2024</a>
        </div>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" style="margin: 0px; font-size: 14px; padding: 0px; background: #F8F8F8;">
          ...
          <a class="dropdown-item" href="#"  onclick="tipoFarmacia2();" style="font-size: 13px;">2023</a>
                <input type="hidden" value="intrahospitalaria 2024" id="tipo4">
                <input type="hidden" value="2024" id="year4">
          <a class="dropdown-item" href="#" onclick="tipoFarmacia2024();" style="font-size: 13px;">2024</a>
