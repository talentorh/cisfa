...
error_reporting(0);
 function formatMoney($number, $cents = 1) { // cents: 0=never, 1=if needed, 2=always
    ...
    $sql = "SELECT COUNT(*) total FROM proveedores WHERE tipoFarmacia = '$contrato' and year = '2021' or tipoFarmacia = '$contrato' and year = '2022' or tipoFarmacia = '$contrato' and year = '2020' or tipoFarmacia = '$contrato' and year = '2023'";
    ...
    FROM proveedores inner join datosproveedor on datosproveedor.id_datoProveedor = proveedores.numero_proveedor where tipoFarmacia = '$contrato' and  proveedores.year = '2021' or  proveedores.tipoFarmacia = '$contrato' and  proveedores.year = '2022' or  proveedores.tipoFarmacia = '$contrato' and  proveedores.year = '2020' or  proveedores.tipoFarmacia = '$contrato' and  proveedores.year = '2023' ORDER by  datosproveedor.datoPersonalProveedor asc";
