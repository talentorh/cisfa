...
$sql = "SELECT COUNT(*) total FROM proveedores WHERE year = '2024' and tipoFarmacia = 'intrahospitalaria 2024'";
...
$query = $conexion2->query("SELECT
    ...
    proveedores.year
    FROM proveedores left outer join datosproveedor on datosproveedor.id_datoProveedor = proveedores.numero_proveedor where proveedores.year = '2024' and tipoFarmacia = 'intrahospitalaria 2024' ORDER by datosproveedor.datoPersonalProveedor asc");
