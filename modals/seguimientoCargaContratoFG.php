...
<body>
    <center>
        ...
        $sql = $conexion2->query("SELECT * from datosproveedor where id_datoProveedor = '$ID_usuario'");
        ...
        <form method="POST" action="redirect-update-contrato">
            ...
            <div class="input-group">
                ...
                <input name="id_proveedor" type="text" class="form-control" placeholder="Clave unica" readonly="readonly" value="<?php echo $row['id_datoProveedor']; ?>">
            </div>
            <label class="fecha-inicio"></label>
            <div class="input-group">
                <div class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></div>
                <input name="nombre_proveedor" type="text" class="form-control" placeholder="Clave unica" readonly="readonly" value="<?php echo $row['datoPersonalProveedor']; ?>">
            </div>
            <br>
