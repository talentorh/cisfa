    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header" style="background: green; color:white; ">
                <h4 class="modal-title"> Cargar medicamento FG</h4>
            </div>
            <div class="modal-body">
                <script>
                    function select_proveedormedicamento() {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "modals/modelo_cargar_medicamentoFG.php",
                            data: ob,
                ...
                <datalist id="lista">
                    ...
                    $sql_s = $conexion2->query("SELECT numero_pedido, id_proveedor FROM proveedores where year = '2024' and tipoFarmacia = 'gratuita 2024'");
