...
<select class="form-control" id="selectCis" name="oficio_informe"  style="height: 35px; width: 100%;" onchange="selectCisfa();">
            ...
            ?>
                ...
                <input type="date" id="dateTo6" class="form-control" required="required" value="" style="width: 100%;">
                <input type="submit" onclick="selectDate2022();" class="btn btn-warning" value="Buscar Medicamento" style="width: 100%; margin-left: 0px; margin-top: 30px; color: white; font-size: 12px;"><br><br>
