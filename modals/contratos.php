            ...
            <div class="modal-body">
                ...
                <div class="modal-body">
                    ...
                    <select class="form-control" id="select_numerocontrato" style="height: 40px; cursor: pointer;" onchange="select_numerocontrato();">
                        ...
                        $sql_s = $conexion2->query("SELECT DISTINCT numero_pedido FROM proveedores where year = '2023' and tipoFarmacia = 'intrahospitalaria 2023' order by numero_pedido asc");
                        while ($row_s = mysqli_fetch_array($sql_s)) {
                    ...
                    <select class="form-control" id="select_tipoFarm" style="height: 40px; cursor: pointer;" onchange="select_tipoFarm();">
                        ...
                        $sql_s = $conexion2->query("SELECT DISTINCT tipoFarmacia FROM proveedores where year = '2023' and tipoFarmacia = 'intrahospitalaria 2023'");
                        while ($row_s = mysqli_fetch_array($sql_s)) {
