                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group"><br>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="id_proveedor" id="id_Proveedor" type="text" class="form-control" required="required" onkeyup="mayus(this);" readonly value="<?php echo $row['id_proveedor']; ?>">
                                    </div>

                                    <label>Numero de orden</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span></div>
                                        <input name="numOrden" id="num_orden" type="text" class="form-control" autocomplete="off">
