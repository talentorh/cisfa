...
$dateTo2 = base64_encode($dateTo);
    ...
    $tabla="";
    $query="SELECT proveedores.*, ordensuministro.*, datosproveedor.datoPersonalProveedor FROM proveedores INNER JOIN datosproveedor on datosproveedor.id_datoProveedor = proveedores.numero_proveedor INNER join ordensuministro on ordensuministro.numerodecontrato = proveedores.numero_pedido WHERE ordensuministro.fechaorden BETWEEN '$dateFrom' AND '$dateTo' AND proveedores.year = '2024' AND proveedores.tipoFarmacia = 'intrahospitalaria 2024' AND ordensuministro.cantidad is not null ";
    ...
    if(!empty($buscarAlumnos) AND mysqli_num_rows($buscarAlumnos)>0)
    {
        ...
        '
  <strong style="float: left; margin-left:0%; font-size: 15px; margin-top: 10px; font-style: italic;"><a href="exportExcelSolicitadoOS2024?dateFrom='.$dateForm2.'&dateTo='.$dateTo2.'" >Exportar a excel</a></strong>
