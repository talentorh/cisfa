...
$query = "SELECT * FROM listamedicamento where fechaContrato = '2024' and farmacia = 'intrahospitalaria' group by listamedicamento.id_medicamento desc ";
$row = mysqli_query($conexion2, $query);
?>
<div id="mensaje"></div>
<table id="datatables-example" class="table table-striped table-bordered table-darkgray table-hover" width="100%">
  <thead>
  ...
  <tbody>
    ...
    ?>
      <tr>
        ...
        <td><button type="button" id="elimina" value='<?php echo $clave ?>' style="background: none; border: 0; color:inherit"> <i id="eliminar" class="lnr lnr-trash"></i></button></td>
