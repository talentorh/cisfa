        ...
        <div class="container" style="margin-top: 10px; width: 700px; padding: 5px;">
            ...
            <form method="POST" action="redirect-update-contratoAdmin">
                ...
                <div class="input-group">
                    ...
                    <input name="id_proveedor" type="hidden" class="form-control" placeholder="Clave unica" readonly="readonly" value="<?php echo $id_datoProveedor; ?>">
                </div>
                <label class="fecha-inicio"></label>
                <div class="input-group">
                    <div class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></div>
                    <input name="nombre_proveedor" type="hidden" class="form-control" placeholder="Clave unica" readonly="readonly" value="<?php echo $nombre_proveedor; ?>">
                </div>
                <div class="input-group">
                    <div class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></div>
                    <input name="" type="text" class="form-control" placeholder="Clave unica" readonly="readonly" value="<?php echo $id_datoProveedor3; ?>">
                </div>
                <label class="fecha-inicio"></label>
                <div class="input-group">
                    <div class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></div>
                    <input name="" type="text" class="form-control" placeholder="Clave unica" readonly="readonly" value="<?php echo $nombre_proveedor3; ?>">
                </div><br>
