<?php session_start();
  ...
  $sql = $conexion2->query("INSERT into numeroorden(id_orden, claveUnicaContrato, estatus, id_contrato, totalOrden, fechaRegistro, fechaEntrego, cumplio, referenciaCorta, diasPenalizados, activarFolio, tipoFarmacia) values(null, '$folio', 0, $id, '0', '0000-00-00', '0000-00-00', 'no', 'OS', 0, 1, 'gratuita')");
