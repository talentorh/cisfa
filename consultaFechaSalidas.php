...
$dateTo2 = base64_encode($dateTo);
    ...
    if(!empty($buscarAlumnos) AND mysqli_num_rows($buscarAlumnos)>0)
    {
        ...
        '
  <strong style="float: left; margin-left:0%; font-size: 15px; margin-top: 10px; font-style: italic;"><a href="exportExcelSolicitadoOS?dateFrom='.$dateForm2.'&dateTo='.$dateTo2.'" >Exportar a excel</a></strong>
