<?php
require_once ('../lib/pdf/fpdf.php'); //importas las libreria
$html ='<html>
          <head></head>
          <body>
...
//corregir la consulta para mostrar los datos de forma correcta en el archivo pdf
